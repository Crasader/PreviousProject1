...
public:
    ...
    vector<PlayerInfo*> getPlayersInfo();
    void addPlayersInfo(PlayerInfo* players);
    ...
    CC_SYNTHESIZE(AgencyRoomList, agencyRoomList, AgencyRoomList);//代理开房数据
    CC_SYNTHESIZE(AgencyRecordList, agencyRecordList, AgencyRecordList);//代理开房记录
    CC_SYNTHESIZE(IPConflictData, iPConflict, IPConflictData);
    CC_SYNTHESIZE(AgencyResultList, agencyResultList, AgencyResultList);
    //游戏状态
    ...
    CC_SYNTHESIZE(bool, isPayWayAA, IsPayWayAA);
    ...
    CC_SYNTHESIZE(std::string, autoRoomId, AutoRoomId);
    ...
    CC_SYNTHESIZE(string, fpDiFen, FPDiFen);
    CC_SYNTHESIZE(string, fpMenQing, FPMenQing)
    CC_SYNTHESIZE(string, privateBaoZi, PrivateBaoZi);
    CC_SYNTHESIZE(string, privateDLNum, PrivateDLNum);
    CC_SYNTHESIZE(string, privateHFNum, PrivateHFNum);
    CC_SYNTHESIZE(string, privateDiLing, PrivateDiLing);
    CC_SYNTHESIZE(string, privateHaoQi, PrivateHaoQi);
    CC_SYNTHESIZE(string, privateZiMo, PrivateZiMo);
    CC_SYNTHESIZE(string, privateQiDui, PrivateQiDui);
    CC_SYNTHESIZE(string, privateFanPai, PrivateFanPai);
    CC_SYNTHESIZE(string, dissolveName, DissolveName);
    CC_SYNTHESIZE(string, fanPaiPoker, FanPaiPoker);
    CC_SYNTHESIZE(string, baiDaPoker, BaiDaPoker);
    ...
    CC_SYNTHESIZE(std::string, mahjongDice, MahjongDice);
