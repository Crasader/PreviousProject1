...
void CMNormalResultLayer::showGameResult(){
...
void CMNormalResultLayer::showRoomInfo(){
...
void CMNormalResultLayer::showPlayerResluts(){
    vector<GameResultData> results = GAMEDATA::getInstance()->getGameResults();
    for (int i=0; i<results.size();i++) {
        CMPlayerResultCell* cell = CMPlayerResultCell::create(results.at(i));
...
void CMNormalResultLayer::showLayerBtn(){
    if(GAMEDATA::getInstance()->getNeedShowLastResult()){
        ...
        schedule(schedule_selector(CMNormalResultLayer::updateTime), 1.0f, kRepeatForever, 0);
        if(GAMEDATA::getInstance()->getIsCompetitionState()){
            auto feedImage = MenuItemImage::create("result/start_game_btn_1.png","result/start_game_btn_2.png",
                                                   CC_CALLBACK_0(CMNormalResultLayer::continueGame, this));
            ...
            auto quitImage = MenuItemImage::create("result/quit_btn_1.png","result/quit_btn_1.png",CC_CALLBACK_0(CMNormalResultLayer::gotoLobby, this));
            
            auto helpImage = MenuItemImage::create("result/xuan_yao_btn_1.png","result/xuan_yao_btn_2.png",
                                                   CC_CALLBACK_0(CMNormalResultLayer::shareResult, this));
...
void CMNormalResultLayer::updatePlayerData(){
...
void CMNormalResultLayer::shareResult(){
    ...
    utils::captureScreen(CC_CALLBACK_2(CMNormalResultLayer::afterCaptured, this) ,path);
#endif
...
void CMNormalResultLayer::afterCaptured(bool succeed, const std::string &outputFile)
{
    if (succeed) {
#if(CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
...
void CMNormalResultLayer::continueGame(){
...
void CMNormalResultLayer::updateTime(float dt){
    totalTime --;
    if(totalTime>=0){
...
void CMNormalResultLayer::onEnter(){
    Layer::onEnter();
...
void CMNormalResultLayer::onExit(){
    Layer::onExit();
