...
std::string CommandManage::getOpenRoomCommand(std::string ftype,std::string haoqi,std::string diling,std::string size,std::string daikai){
    std::map<std::string, std::string> keyValue;
    ...
    keyValue.insert(map<string, string>::value_type("ifhaoqi", haoqi));
    keyValue.insert(map<string, string>::value_type("ifdiling", diling));
    keyValue.insert(map<string, string>::value_type("ftype", ftype));
    keyValue.insert(map<string, string>::value_type("size", size));
    keyValue.insert(map<string, string>::value_type("daikai", daikai));
    keyValue.insert(map<string, string>::value_type("jd", UserData::getInstance()->getLongitude()));
    keyValue.insert(map<string, string>::value_type("wd", UserData::getInstance()->getLatitude()));
    return commandString(keyValue);
}
...
std::string CommandManage::getThirdLoginCommand(std::string openid,std::string unionid,std::string head,std::string sex,std::string nickname,std::string hsman,std::string hstype,std::string imsi,std::string imei,std::string ver1,std::string jdnum,std::string wdnum,bool tag){
    ...
    keyValue.insert(map<string, string>::value_type("jd",jdnum));
    keyValue.insert(map<string, string>::value_type("wd", wdnum));
    if(tag)
...
std::string CommandManage::getDissolveRoomCommand(std::string prid){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FRIEND_DISMISS_FZ_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("prId", prid));
    return commandString(keyValue);
}
...
std::string CommandManage::getCertification(std::string name, std::string sfz,std::string sjh){
    std::map<std::string, std::string> keyValue;
    ...
    keyValue.insert(map<string, string>::value_type("phone", sjh));
    return commandString(keyValue);
}

std::string CommandManage::getSuZhouHuRequest(){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_IFHU_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("flag", "1"));
    return commandString(keyValue);
}

std::string CommandManage::getEnterHongZhongCommand(std::string ftype,std::string ma,std::string difen,std::string size,std::string daikai){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getHZDissolveRoomCommand(std::string prid){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getBDOpenRoomCommand(std::string ftype,std::string ifzimo,std::string ifqidui,std::string fanpai,std::string size,std::string daikai){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_CM_FRIEND_GAME_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("ftype", ftype));
    keyValue.insert(map<string, string>::value_type("ifzm", ifzimo));
    keyValue.insert(map<string, string>::value_type("qidui", ifqidui));
    keyValue.insert(map<string, string>::value_type("fanpai", fanpai));
    keyValue.insert(map<string, string>::value_type("size", size));
    keyValue.insert(map<string, string>::value_type("daikai", daikai));
    keyValue.insert(map<string, string>::value_type("jd", UserData::getInstance()->getLongitude()));
    keyValue.insert(map<string, string>::value_type("wd", UserData::getInstance()->getLatitude()));
...
std::string CommandManage::getBDDissovleRoomReq(std::string prid){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getFPDissovleRoomReq(std::string prid){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_FRIEND_DISMISS_FZ_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("prId", prid));
    return commandString(keyValue);
}

std::string CommandManage::sendBDReadyCommand(){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::sendBDDissovleRoomRequest(){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getBDDissolveRoomSelectCommand(std::string agree){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getBDPlayPokeCommand(int po){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getBDPengCommand(std::string peng, int poker){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getBDGangCommand(std::string gang, int poker, int flag){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getBDGiveUpCommand(){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getBDHuActionCommand(std::string msg){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getBDOutResumeCommand(){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage:: getBDContinueGameCommand(){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getBDQuitRoomCommand(){
    std::map<std::string, std::string> keyValue;
...
std::string CommandManage::getFPQuitRoomCommand(){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_MAJIANG_OUT_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    return commandString(keyValue);
}

std::string CommandManage::getFanPaiOpenRoomCommand(std::string ftype,std::string ifmq,std::string difen,std::string size,std::string daikai){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_FRIEND_GAME_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("ftype", ftype));
    keyValue.insert(map<string, string>::value_type("difen", difen));
    keyValue.insert(map<string, string>::value_type("size", size));
    keyValue.insert(map<string, string>::value_type("daikai", daikai));
    keyValue.insert(map<string, string>::value_type("ifmq", ifmq));
    keyValue.insert(map<string, string>::value_type("jd", UserData::getInstance()->getLongitude()));
    keyValue.insert(map<string, string>::value_type("wd", UserData::getInstance()->getLatitude()));
    return commandString(keyValue);
}
...
std::string CommandManage::sendFPReadyCommand(){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_READY_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    return commandString(keyValue);
}

std::string CommandManage::sendFPDissovleRoomRequest(){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_FRIEND_DISMISS_FZAGREE_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    return commandString(keyValue);
}


std::string CommandManage::getFPPlayPokeCommand(int po){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_MAJIANG_DISPATCH_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("seatId", StringUtil::itos(GAMEDATA::getInstance()->getHeroSeatId())));
    keyValue.insert(map<string, string>::value_type("GID", StringUtil::itos(1)));
    keyValue.insert(map<string, string>::value_type("poker", StringUtil::itos(po)));
...
std::string CommandManage::getFPDissolveRoomSelectCommand(std::string agree){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_FRIEND_DISMISS_AGREE_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("agree",agree));
    return commandString(keyValue);
}

std::string CommandManage::getFPPengCommand(std::string peng, int poker){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_MAJIANG_PENG_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("seatId", StringUtil::itos(GAMEDATA::getInstance()->getHeroSeatId())));
    keyValue.insert(map<string, string>::value_type("peng", peng));
    keyValue.insert(map<string, string>::value_type("poker", StringUtil::itos(poker)));
...
std::string CommandManage::getFPGangCommand(std::string gang, int poker, int flag){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_MAJIANG_GANG_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("seatId", StringUtil::itos(GAMEDATA::getInstance()->getHeroSeatId())));
    keyValue.insert(map<string, string>::value_type("gang", gang));
    keyValue.insert(map<string, string>::value_type("poker", StringUtil::itos(poker)));
...
std::string CommandManage::getFPGiveUpCommand(){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_MAJIANG_NO_CHI_PENG_GANG_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("seatId", StringUtil::itos(GAMEDATA::getInstance()->getHeroSeatId())));
    keyValue.insert(map<string, string>::value_type("GID", StringUtil::itos(1)));
    return commandString(keyValue);
...
std::string CommandManage::getFPOutResumeCommand(){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_MAJIANG_BACK_OUT_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    return commandString(keyValue);
}

std::string CommandManage:: getFPContinueGameCommand(){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_MAJIANG_AGAIN_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("plat", PAY_PLAT_VALUE));
    return commandString(keyValue);
}
std::string CommandManage::getFPHuActionCommand(std::string msg){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_FPBD_IFHU_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("flag", msg));
    return commandString(keyValue);
}

std::string CommandManage::sendAgencyInfo(std::string flag){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_DAIKAI_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    keyValue.insert(map<string, string>::value_type("flag", flag));
    return commandString(keyValue);
}

std::string CommandManage::sendAgencyBill(){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_DAIKAI_FRIEND_GAME_BILL_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    return commandString(keyValue);
}

std::string CommandManage::sendAgencyResult(){
    std::map<std::string, std::string> keyValue;
    keyValue.insert(map<string, string>::value_type("code", StringUtil::itos(MSGCODE_DAIKAI_BILL_REQUEST)));
    keyValue.insert(map<string, string>::value_type("poxiaoId", UserData::getInstance()->getPoxiaoId()));
    return commandString(keyValue);
}
