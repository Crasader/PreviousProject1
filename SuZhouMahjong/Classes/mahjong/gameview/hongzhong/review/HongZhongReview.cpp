...
void HongZhongReview::initHongZhongMahjong(){
...
void HongZhongReview::doRecoverGame(){
    //重绘制场景
...
void HongZhongReview::doRecoverPlayer(PlayerGameData data, int type, PlayerInfo* playerInfo){
...
void HongZhongReview::showHongZhongControllPad(PlayerCpgtData newData){
    controllPad->removeAllChildrenWithCleanup(true);
    auto qi = MenuItemImage::create("gameview/mj_qi.png", "gameview/mj_qi.png", CC_CALLBACK_1(HongZhongReview::doHongZhongQiAction,this));
    ...
    if (newData.hu == 1){
        hu = MenuItemImage::create("gameview/mj_hu.png", "gameview/mj_hu.png", CC_CALLBACK_1(HongZhongReview::doHongZhongHuAction, this));
    ...
    if (newData.peng != ""){
        peng = MenuItemImage::create("gameview/mj_peng.png", "gameview/mj_peng.png", CC_CALLBACK_1(HongZhongReview::doHongZhongPengAction, this));
    ...
    if (newData.playerGang.size()>0){
        ...
        gang = MenuItemImage::create("gameview/mj_gang.png", "gameview/mj_gang.png", CC_CALLBACK_1(HongZhongReview::showHongZhongGangChoice, this));
...
void HongZhongReview::hideHongZhongControllPad(){
...
void HongZhongReview::doHongZhongQiAction(Ref* ref){
    controllPad->setVisible(false);
...
void HongZhongReview::doHongZhongHuAction(Ref* ref){
    controllPad->setVisible(false);
    NetworkManage::getInstance()->sendMsg(CommandManage::getInstance()->getHZHuActionCommand("1"));
}


void HongZhongReview::doHongZhongPengAction(Ref* ref){
    controllPad->setVisible(false);
    playerHero->stopTimeClockAnim();
...
void HongZhongReview::doHongZhongGangAction(Ref* ref){
    controllPad->setVisible(false);
    playerHero->stopTimeClockAnim();
...
void HongZhongReview::showHongZhongGangChoice(Ref* ref){
    controllPad->setVisible(false);
    MenuItemImage* temp = (MenuItemImage*)ref;
    ...
    if (allGangs.size()>1){
        ...
        for (int i = 0; i < allGangs.size(); i++){
            ...
            for (int l = 0; l < 4; l++){
                ...
                MenuItemImage* imageItem = MenuItemImage::create(imageName, imageName, CC_CALLBACK_1(HongZhongReview::doHongZhongGangAction, this));
...
void HongZhongReview::dealJongFinish(MahjongFaPaiData data){
...
void HongZhongReview::firstPlayPoker(PlayerCpgtData data) {
...
void HongZhongReview::showHuPaiXing(std::string paixing){
    if(paixing==""){
        return;
    }
...
void HongZhongReview::showHandPokerOver(int seatId){
    vector<GameResultData> results = GAMEDATA::getInstance()->getGameResults();
    string leftJongs="";
    string rightJongs="";
...
void HongZhongReview::controlDown(){
    interval =0;
...
void HongZhongReview::controlPause(){
    playing= !playing;
...
void HongZhongReview::controlUp(){
...
void HongZhongReview::controlBack(){
...
void HongZhongReview::update(float dt){
    interval += dt;
    if(playing){
        if(interval>1.2){
            if(fupanStep<GAMEDATA::getInstance()->getPlaybackInfo().playBackInfo.size()){
...
void HongZhongReview::onEnterTransitionDidFinish(){
    scheduleUpdate();
...
void HongZhongReview::onEnter(){
    ...
    fupanPlayerInfoListener = EventListenerCustom::create(MSG_GAME_FU_PAN_PLAYER_NOTIFY, [=](EventCustom* event){
        ...
        image1= MenuItemImage::create("fupan/down_1.png", "fupan/down_2.png",CC_CALLBACK_0(HongZhongReview::controlDown, this));
        auto image2 = MenuItemImage::create("fupan/pause_1.png", "fupan/pause_2.png",CC_CALLBACK_0(HongZhongReview::controlPause, this));
        image2->setTag(1087);
        image3 = MenuItemImage::create("fupan/up_1.png", "fupan/up_2.png","fupan/up_3.png",CC_CALLBACK_0(HongZhongReview::controlUp, this));
        MenuItemImage* image4 = MenuItemImage::create("fupan/back_1.png", "fupan/back_2.png",CC_CALLBACK_0(HongZhongReview::controlBack, this));
