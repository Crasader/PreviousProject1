...
#define MSGCODE_IFHU_NOTIFY  2064// 麻将可以胡通知{code:2064,poxiaoId:"123"}
#define MSGCODE_IFHU_REQUEST  2065// 麻将胡牌请求{code:2065,poxiaoId:"123",flag:"1"} flag为1是确认胡牌，2是取消胡牌
#define MSGCODE_DAIKAI_REQUEST  2066// 代开结果请求{code:2066,poxiaoId:"123"}
#define MSGCODE_DAIKAI_RESPONSE 2067// 代开结果回复
#define MSGCODE_DAIKAI_FRIEND_GAME_BILL_REQUEST  2068//获取代开账单请求{code:2068,poxiaoId:poxiaoId}
#define MSGCODE_DAIKAI_FRIEND_GAME_BILL_RESPONSE  2069//获取代开账单回复
#define MSGCODE_IP_NOTIFY  2070//ip冲突提示{code:2070,poxiaoId:poxiaoId,ip:["A和BIP一致","C和DIP一致"]}
#define MSGCODE_DAIKAI_BILL_REQUEST  2071//获取代理账单请求{code:2071,poxiaoId:poxiaoId}
#define MSGCODE_DAIKAI_BILL_RESPONSE  2072//获取代理账单回复{code:2072,poxiaoId:poxiaoId,time:"2017-01-01",bill:[{nickname:"阿三",count:"1","fangka":"2"},{nickname:"阿三",count:"1","fangka":"2"}]}
/**
 红中麻将协议
 **/
...
#define MSGCODE_FPBD_MAJIANG_BACK_OUT_REQUEST 5000//后台切出请求{code:5000,poxiaoId:poxiaoId}
#define MSGCODE_FPBD_MAJIANG_AGAIN_REQUEST 5001//再来一局请求{code:5001,poxiaoId:poxiaoId}
#define MSGCODE_FPBD_MAJIANG_AGAIN_RESPONSE 5002//再来一局回复{code:5002,poxiaoId:poxiaoId,result:1,rsid:1000,kb:"1"}1为成功 2为金币小于下限 3为金币高于上限rsid为跳转房间
#define MSGCODE_FPBD_READY_REQUEST 5003// 麻将客户端到服务端准备请求{code:5003,poxiaoId:poxiaoId}
#define MSGCODE_FPBD_READY_RESPONSE 5004// 麻将服务端到客户端准备回复{code:5004,poxiaoId:poxiaoId,result:1,rsid:'1111'}
#define MSGCODE_FPBD_LOGIN_NOTIFY 5005// 麻将服务端到客户端登陆通知{code:5005,result:0,poxiaoId:poxiaoId,seatId:seatId,gold:0,diamond:0,jifen:0,lequan:0,gender:0,nickname:'aaa',ifready:0,pId:pId} gender性别0女1男 ifready准备0未准备1准备
#define MSGCODE_FPBD_READY_NOTIFY 5006// 麻将服务端到客户端准备通知{code:5006,poxiaoId:poxiaoId,seatId:1}
#define MSGCODE_FPBD_MAJIANG_FIRSTHUA_REQUEST 5007// 首次清理花牌请求{code:5007,poxiaoId:poxiaoId,seatId:seatId}
#define MSGCODE_FPBD_MAJIANG_DISCARD_NOTIFY 5008// 开始游戏,发牌通知{code:5008,poxiaoId:poxiaoId,start:1,dice:"3,6",poker:"1,2,4,5,6",kb:"1",hf:"2",prjucount:1,matchname:"10元比赛"} 私人房间进行到的局数prjucount
#define MSGCODE_FPBD_MAJIANG_DISPATCH_REQUEST 5010// 出牌请求{code:5010,poxiaoId:poxiaoId,seatId:seatId,poker:poker}
#define MSGCODE_FPBD_MAJIANG_DISPATCH_NOTIFY 5011// 出牌通知{code:5011,poxiaoId:poxiaoId,seatId:seatId,poker:poker}
#define MSGCODE_FPBD_MAJIANG_PLAYER_CPG_NOTIFY 5012//玩家胡吃碰杠通知{code:5012,poxiaoId:poxiaoId,seatId:seatId,poker:1,hu:"1",chi:[{chi:1,2,3},{chi:2,3,4}],peng:"1,2,3",gang:"1,1,1,1"}
#define MSGCODE_FPBD_MAJIANG_PENG_REQUEST 5016// 碰牌请求{code:5016,poxiaoId:poxiaoId,seatId:seatId,peng:"1,2",poker:poker}
#define MSGCODE_FPBD_MAJIANG_PENG_RESPONSE 5017// 碰牌回复{code:5017,poxiaoId:poxiaoId,seatId:seatId,result:1,ting:"1,2,3"}  1成功0失败
#define MSGCODE_FPBD_MAJIANG_PENG_NOTIFY 5018// 碰牌通知{code:5018,poxiaoId:poxiaoId,seatId:seatId,peng:"1,2",poker:poker,sId:2} seatId为碰牌人的座位号
#define MSGCODE_FPBD_MAJIANG_GANG_REQUEST 5019// 杠牌请求{code:5019,poxiaoId:poxiaoId,seatId:seatId,gang:"1,1,1",poker:poker,flag:0} flag 0为明杠1为暗杠,2碰杠
#define MSGCODE_FPBD_MAJIANG_GANG_RESPONSE 5020// 杠牌回复{code:5020,poxiaoId:poxiaoId,seatId:seatId,result:1}  1成功0失败
#define MSGCODE_FPBD_MAJIANG_GANG_NOTIFY 5021// 杠牌通知{code:5021,poxiaoId:poxiaoId,seatId:seatId,gang:"1,1,1",poker:poker,flag:0,sId:2} seatId为杠牌人的座位号 1暗杠 2碰杠 0普通杠
#define MSGCODE_FPBD_MAJIANG_NO_CHI_PENG_GANG_REQUEST 5022// 取消吃碰杠牌请求{code:5022,poxiaoId:poxiaoId,seatId:seatId}
#define MSGCODE_FPBD_MAJIANG_POKER_NOTIFY 5024//游戏中发牌{code:5024,poxiaoId:poxiaoId,seatId:seatId,poker:{poker:1,hua:32,33},hu:"1",angang:"",penggang:""}poker为花时替换牌,hu为是否可以胡牌,angang暗杠 penggang 碰杠
#define MSGCODE_FPBD_MAJIANG_TING_GANG_NOTIFY 5025// 杠牌通知{code:5025,poxiaoId:poxiaoId,seatId:seatId,ting:"1,2,3",angang:"1,1,1,1",penggang:"1"} ting为打掉那张牌可以听牌
#define MSGCODE_FPBD_MAJIANG_FINISH_NOTIFY 5028//结算通知 ,结算,result0为平,1为自摸,2为放炮 3胡牌  4输
//{code:5028,flag:"1",poxiaoId:poxiaoId,seatId:seatId,poker:1,finish:[{result:1,hutype:1,2,3,seatId:1,nickname:"rr",gold:0,diamond:0,jifen:0,lequan:0,golddelta:0,diamonddelta:0,jifendelta:0,lequandelta:0,hua:1,poker:1,2,3},{result:1,hutype:1,2,3,seatId:1,nickname:"rr",gold:0,diamond:0,jifen:0,lequan:0,golddelta:0,diamonddelta:0,jifendelta:0,lequandelta:0,hua:1,poker:1,2,3}]}
#define MSGCODE_FPBD_MAJIANG_OUT_REQUEST 5029//退出游戏请求{code:5029,poxiaoId:poxiaoId,seatId:seatId}
#define MSGCODE_FPBD_MAJIANG_OUT_RESPONSE 5030// 退出游戏回复{code:5030,poxiaoId:poxiaoId,seatId:seatId,result:1}
#define MSGCODE_FPBD_MAJIANG_OUTLINE_RESUME_NOTIFY 5031
//断线续完{code:5031,poxiaoId:poxiaoId,seatId:1,lord:1,rest:"123",status:1,all:[{seatId:1,hua:"1",chi:[{chi:"1,2,3",poker:"3"},{chi:"11,12,13",poker:"13"}],peng:[{peng:"11",peId:"1"},{peng:"12",peId:"2"}],gang:[{gang:"11",gaId:"1"},{gang:"12",gaId:"2"}],angang:"6",out:"11,22,33,44",gold:0,diamond:0,jifen:0,lequan:0,gender:0,nickname:'aaa',hand:"2",status:1,prId:"123",fzId:"456",prjucount:"1",prjushu:"2"}],matchname:"10元比赛"} status1为听牌
#define MSGCODE_FPBD_FRIEND_GAME_REQUEST 5032// 好友开房请求{code:5032,poxiaoId:"123",ftype:"1",size:"4",difen:"1",lz:"1"} ftype 1为打八局 2为打4局3为16局 ifkb 0为无开宝,1为有开宝 size4为4人2为2人,fcy飞苍蝇0为无,1为有,dihua 0为1/1 1为2/2 2为6/2 3为5/5,lz0为20勒子 1为50勒子 2为100勒子 3为无勒子
#define MSGCODE_FPBD_FRIEND_GAME_NOTIFY 5033// 好友开房通知{code:5033,poxiaoId:"123",nickname:"aaa",pId:"456"}
#define MSGCODE_FPBD_FRIEND_GAME_RESPONSE 5034//好友开房回复{code:5034,poxiaoId:poxiaoId,result:"0",seatId:1,prId:"1234",prjushu:"8"} prjushu 8\16
#define MSGCODE_FPBD_FRIEND_JOIN_GAME_REQUEST 5035// 好友加入房间请求{code:5035,poxiaoId:"123",pId:"456"}
#define MSGCODE_FPBD_FRIEND_JOIN_GAME_RESPONSE 5036//好友进入房间回复{code:5036,poxiaoId:poxiaoId,result:0,seatId:1,other:[{seatId:seatId,gold:0,diamond:0,jifen:0,lequan:0,gender:0,nickname:'aaa',ifready:1,pic:"1"}],prId:"1234",prjushu:"8",iflezi:"0"} iflezi为0表示无勒子1表示有勒子 result 0为自己在游戏中 1为成功 2为房间已满
#define MSGCODE_FPBD_FRIEND_JOIN_GAME_FJH_REQUEST 5037// 好友输入房间号加入房间请求{code:5037,poxiaoId:"123",prId:"456"}

#define MSGCODE_FPBD_FRIEND_DISMISS_NOTIFY 5038// 私人房间可以解散通知{code:5038,poxiaoId:"123"}
#define MSGCODE_FPBD_FRIEND_DISMISS_FZAGREE_REQUEST 5039//私人房间解散请求{code:5039,poxiaoId:poxiaoId}
#define MSGCODE_FPBD_FRIEND_DISMISS_AGREE_NOTIFY 5040// 私人房间是否同意解散通知{code:5040,poxiaoId:"123"}
#define MSGCODE_FPBD_FRIEND_DISMISS_AGREE_REQUEST 5041//私人房间是否同意解散请求{code:5041,poxiaoId:poxiaoId,agree:0} 0为不同意 1为同意
#define MSGCODE_FPBD_FRIEND_DISMISS_AGREE_RESULT_NOTIFY 5042//私人房间是否同意解散通知{code:5042,poxiaoId:poxiaoId,pId:11,agree:0} 0为不同意 1为同意,pId为谁同意了或则不同意了
#define MSGCODE_FPBD_FRIEND_DISMISS_FZ_REQUEST 5043//私人房间房主解散请求{code:5043,poxiaoId:poxiaoId,prId:"1234"}
#define MSGCODE_FPBD_IFHU_NOTIFY 5044// 麻将可以胡通知{code:5044,poxiaoId:"123"}
#define MSGCODE_FPBD_IFHU_REQUEST 5045// 麻将胡牌请求{code:5045,poxiaoId:"123",flag:"1"} flag为1是确认胡牌，2是取消胡牌
...
#define MSG_PALYER_ENTER_GAME "MSG_PALYER_ENTER_GAME"
...
#define MSG_SZ_GAME_HU_ACTION "MSG_SZ_GAME_HU_ACTION"
/** 红中麻将**/
...
#define MSG_GAME_BD_START_FAPAI_NOTIFY "MSG_GAME_BD_START_FAPAI_NOTIFY"
/*翻牌百搭*/
#define MSG_FP_FRIEND_OPEN_ROOM_RESP "MSG_FP_FRIEND_OPEN_ROOM_RESP"
#define MSG_PLAYER_FP_CONNECT_AGAIN "MSG_PLAYER_FP_CONNECT_AGAIN"
#define MSG_FP_ENTER_FRIEND_ROOM_RESP "MSG_FP_ENTER_FRIEND_ROOM_RESP"
#define MSG_GAME_FP_START_FAPAI_NOTIFY "MSG_GAME_FP_START_FAPAI_NOTIFY"
#define MSG_FP_PLAYER_TURN_WHO "MSG_FP_PLAYER_TURN_WHO"

#define MSG_AGENCY_LIST "MSG_AGENCY_LIST"
#define DAIKAI_FRIEND_GAME_BILL_REQUEST "DAIKAI_FRIEND_GAME_BILL_REQUEST"
#define MSG_IP_CONFLICT "MSG_IP_CONFLICT"
#define MSG_RESULT_MSG "MSG_RESULT_MSG"
#endif
