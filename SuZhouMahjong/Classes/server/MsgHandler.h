...
private:
    ...
    void showBDCpgNotify(std::string msg);
    void cmHeroChiResp(std::string msg);
    void showCMOtherChiNotify(std::string msg);
    void bdHeroPengResp(std::string msg);
    void showBDOtherPengNotify(std::string msg);
    void bdHeroGangResp(std::string msg);
    void showBDOtherGangNotify(std::string msg);
    void gameCMResultNotify(std::string msg);
    void handleCMPlayerHuNotify(std::string msg);
    void gameBDContinueResp(std::string msg);
    void gameTuiGuangResp(std::string msg);
    void handleHzPengResp(std::string msg);
    void handleSuZhouHuNotify(std::string msg);
    void handleFanPaiOpenRoom(std::string msg);
    void handleFanPaiConnect(std::string msg);
    void handleFanPaiEnterRoom(std::string msg);
    void handleFPFapaiNotify(std::string msg);
    void fpNextPlayer(std::string msg);
    void manageAgencyResp(std::string msg);
    void agencyBillResp(std::string msg);
    void playerIPCheckNotify(std::string msg);
    void agencyResultResp(std::string msg);
};
#endif
