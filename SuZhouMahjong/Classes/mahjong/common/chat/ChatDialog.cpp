...
bool ChatDialog::init(){
    ...
    MenuItemImage* image = MenuItemImage::create("chat/quick_chat_btn_1.png","chat/quick_chat_btn_2.png",CC_CALLBACK_0(ChatDialog::setQuickChatVisible, this));
    auto quickChatBtn  = Menu::create(image,NULL);
    quickChatBtn->setPosition(805,85);
    addChild(quickChatBtn);
    
    MenuItemImage* face = MenuItemImage::create("chat/face_btn_1.png","chat/face_btn_2.png",CC_CALLBACK_0(ChatDialog::setFaceChatVisible, this));
...
void ChatDialog::setQuickChatVisible(){
    if(NULL != getChildByTag(1116)){
        getChildByTag(1116)->setVisible(!getChildByTag(1116)->isVisible());
    }
...
void ChatDialog::setFaceChatVisible(){
    if(NULL != getChildByTag(1116)){
        getChildByTag(1116)->setVisible(false);
    }
    if(NULL != getChildByTag(1117)){
        getChildByTag(1117)->setVisible(!getChildByTag(1117)->isVisible());
    }
}
