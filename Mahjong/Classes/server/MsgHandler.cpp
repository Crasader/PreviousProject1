...
void MsgHandler::distribute(int code, std::string msg){
    switch (code)
    {
        ...
        case MSGCODE_HH_MAJIANG_DISPATCH_NOTIFY:{
            handleHZPlayerPlayPokerNotify(msg);
        }
            break;
        ...
        case MSGCODE_MATCH_OUT_RESPONSE:
        {
            ...
            break;
        case MSGCODE_MATCH_OUT_REQUEST:{
...
void MsgHandler::handleHZPlayerPlayPokerNotify(std::string msg){
    ...
    std::string resultMsg = StringUtils::format("%d,%s",seatId.GetInt(),poker.GetString());
    char* buf = const_cast<char*>(resultMsg.c_str());
    postNotifyMessage(MSG_HZ_OTHER_PALYER_JONG, buf);
}
...
void MsgHandler::handleCompetitionStart(std::string msg){
    rapidjson::Document _mDoc;
    RETURN_IF(NULL == msg.c_str() || !msg.compare(""));
    _mDoc.Parse<0>(msg.c_str());
    RETURN_IF(_mDoc.HasParseError() || !_mDoc.IsObject());
...
void MsgHandler::showCMCpgNotify(std::string msg){
    rapidjson::Document _mDoc;
    RETURN_IF(NULL == msg.c_str() || !msg.compare(""));
    _mDoc.Parse<0>(msg.c_str());
    RETURN_IF(_mDoc.HasParseError() || !_mDoc.IsObject());
...
void MsgHandler::cmHeroPengResp(std::string msg){
    rapidjson::Document _mDoc;
    RETURN_IF(NULL == msg.c_str() || !msg.compare(""));
    _mDoc.Parse<0>(msg.c_str());
    RETURN_IF(_mDoc.HasParseError() || !_mDoc.IsObject());
...
void MsgHandler::showCMOtherPengNotify(std::string msg){
    rapidjson::Document _mDoc;
    RETURN_IF(NULL == msg.c_str() || !msg.compare(""));
    _mDoc.Parse<0>(msg.c_str());
    RETURN_IF(_mDoc.HasParseError() || !_mDoc.IsObject());
...
void MsgHandler::cmHeroGangResp(std::string msg){
    rapidjson::Document _mDoc;
    RETURN_IF(NULL == msg.c_str() || !msg.compare(""));
    _mDoc.Parse<0>(msg.c_str());
    RETURN_IF(_mDoc.HasParseError() || !_mDoc.IsObject());
...
void MsgHandler::showCMOtherGangNotify(std::string msg){
    rapidjson::Document _mDoc;
    RETURN_IF(NULL == msg.c_str() || !msg.compare(""));
    _mDoc.Parse<0>(msg.c_str());
    RETURN_IF(_mDoc.HasParseError() || !_mDoc.IsObject());
