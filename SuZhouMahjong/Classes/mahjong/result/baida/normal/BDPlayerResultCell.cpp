...
BDPlayerResultCell* BDPlayerResultCell::create(GameResultData data){
    BDPlayerResultCell* cell = new BDPlayerResultCell();
...
bool BDPlayerResultCell::init(GameResultData data){
    if(!Sprite::init()){
        return false;
    }
