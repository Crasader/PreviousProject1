...
void AppDelegate::applicationDidEnterBackground() {
    ...
    if(GAMEDATA::getInstance()->getGameType() == 1){
        ...
        NetworkManage::getInstance()->sendMsg(CommandManage::getInstance()->getBDOutResumeCommand());
    }else if(GAMEDATA::getInstance()->getGameType() == 7){
        NetworkManage::getInstance()->sendMsg(CommandManage::getInstance()->getFPOutResumeCommand());
    }
