...
void DissovleRoomDialog::doAgree(){
    ...
    if(GAMEDATA::getInstance()->getGameType() == 1){
        ...
        NetworkManage::getInstance()->sendMsg(CommandManage::getInstance()->getBDDissolveRoomSelectCommand("1"));
    }else if(GAMEDATA::getInstance()->getGameType() == 7){
        NetworkManage::getInstance()->sendMsg(CommandManage::getInstance()->getFPDissolveRoomSelectCommand("1"));
    }
...
void DissovleRoomDialog::doNotAgree(){
    ...
    if(GAMEDATA::getInstance()->getGameType() == 1){
        ...
        NetworkManage::getInstance()->sendMsg(CommandManage::getInstance()->getBDDissolveRoomSelectCommand("0"));
    }else if(GAMEDATA::getInstance()->getGameType() == 7){
        NetworkManage::getInstance()->sendMsg(CommandManage::getInstance()->getFPDissolveRoomSelectCommand("0"));
    }
    GAMEDATA::getInstance()->setDissovleDialogRemove(true);
    checkAllConfirm();
}
