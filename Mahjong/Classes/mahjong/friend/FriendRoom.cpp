...
bool FriendRoom::init()
{
    ...
    lezi40Info->setPosition(680,320);
    addChild(lezi40Info);
    ...
    wukaibaoIcon->setPosition(360,255);
    ...
    mo2chong3Icon->setPosition(680,255);
