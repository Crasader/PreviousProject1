package com.tiaotiao.suzhou.wxapi;
					...
					Payment.getWechatToken(authresp.code, new WechatLoginCallBack() {
						...
						public void callBack(WxUserInfo info) {
							...
							JniPayCallbackHelper.loginThirdPlatform(info.getOpenId(),info.getUnionid(),info.getHeadImage(),
									...
									DeviceInfo.getModle(), DeviceInfo.getImsi(), DeviceInfo.getImei(), AppInfo.getVersion(),TbuWxUtil.getInstance().getPlayerLocationLongitude(),TbuWxUtil.getInstance().getPlayerLocationLatitude());
