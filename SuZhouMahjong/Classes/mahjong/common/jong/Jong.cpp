...
void Jong::showJong(int bType, int cType,bool show){
    ...
    if (show){
        ...
        protectedIcon->setScale(getContentScaleByType(bType));
...
//void Jong::showBackShadowNotLock(bool show){
//     protectedIcon->setVisible(show);
//}
//
//bool Jong::isJongShowShadow(){
//    if(protectedIcon->isVisible()){
//        return true;
//    }else{
//        return false;
//    }
...
void Jong::showBaiDaPoker(){
    auto ioc2 = Sprite::create("jong/icon_baida.png");
    ioc2->setAnchorPoint(Point::ANCHOR_BOTTOM_LEFT);
    ioc2->setPosition(-10,-5);
    addChild(ioc2,100);
}
...
std::string Jong::getContextImage(int cType){
    ...
    switch (cType)
    {
        ...
        case JongEnum::lan:
            ...
            break;
        case JongEnum::shu:
            imageName = "jong/laoshu.png";
            break;
        case JongEnum::cai:
            imageName = "jong/cai.png";
            break;
        case JongEnum::mao:
            imageName = "jong/mao.png";
            break;
        case JongEnum::bao:
            imageName = "jong/jubao.png";
            break;
        case JongEnum::baida:
            imageName = "jong/baida.png";
            break;
        default:
            break;
    }
