...
public:
    ...
    void loginThirdPlatform(std::string openid,std::string url,std::string sex,std::string nickname,std::string hsman,std::string hstype,std::string imsi,std::string imei,std::string ver1);
